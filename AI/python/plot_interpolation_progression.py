...
input_file = open( "../data/basis_functions.dat", "r")
lines_basis_functions = input_file.readlines()
input_file.close()

input_file = open( "../data/interpolation_progression.dat", "r")
line_interpolation_progression = input_file.readlines()
input_file.close()

if len(lines_basis_functions)==0 or len(line_interpolation_progression)==0:
    print("Invalid dimension d, d must be 2 or 3")
    sys.exit(1)
