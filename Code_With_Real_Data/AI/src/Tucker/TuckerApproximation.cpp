...
{
    infoFileName = Utils::projectPath + "Tucker/LIVRAISON_THESE_Paris6_" + _core + "_test/GeneralInfor_" + _core + ".txt";
    core = _core;
    dimension = 5;
    keys.push_back("0");
    keys.push_back("1");
...
void TuckerApproximation::setListOfFiles()
{
    for (string cs : listOfCrossSectionNames)
    {
        ...
        listOfFiles.insert(pair<string,string>(cs,Utils::projectPath + "Tucker/LIVRAISON_THESE_Paris6_" + core + "_test/TuckerInfor_" + s + ".txt"));
    }
}
