...
def getFinalTuckerCoeffs(NameFile):
    ...
    if str_old in converted_line:
        converted_line = replace_str(converted_line, str_old, str_new)
    ### A particular cas of UOX, scattering001
    if NameFile != "TuckerInfor_macro_scattering001.txt":
        str_old = " "
        str_new = ", "
        converted_line = replace_str(converted_line, str_old, str_new)
...
def getFinalTuckerCoeffs_old(NameFile):
    strs_begin = "Coefficient values" #self.finalOrthNormalizedEigVects: [[ "
    strs_end = "]"
    lines = check_string(strs_begin, strs_end, NameFile)
...
"""
Petit changement dans fct getFinalTuckerCoeffs
...
if __name__ == "__main__":
    ...
    ###===================================================
    """
    CHANGE ICI POUR CHAQUE CAS TEST
    """
    NameFile = "GeneralInfor_UOX.txt"
    ###===================================================
...
###=========================================
    ...
    CHANGE ICI POUR CHAQUE CAS TEST
    """
    repertoire = "FinalResults_eps1E_10_14700p_UOX_better_extendedD_Paris6/"
    nameTest="RelativeError_AP2_Cocagne_Tucker_eps1E_10_14700p_UOX_extend_18mai_"
    ###===================================================
    ...
    ###===================================================
    point =  [0.0, 123.0, 0.40000000596, 0.0, 9.99999997475e-07]
    csName = "macro_totale0"
