...
L'algorithme d'Interpolation Adaptative a été tésté sur des fonctions analytiques définies à l'avance, en une grille de référence construite d'une manière aléatoire.\\
