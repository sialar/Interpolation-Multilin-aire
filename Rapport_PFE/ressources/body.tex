...
En effet, en sortie de l'algorithme, on n'obtient pas forcement une grille tensorille mais plutôt un ensemble monotone de multi-indices (qui correspond à un ensemble de point 2D).
