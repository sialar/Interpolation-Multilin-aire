...
\fbox{\begin{minipage}{0.9\textwidth}
\begin{itemize}
\item Commencer par $\Lambda_1 = \left \{0_{\mathcal{F}} \right \}$
...
\begin{tabular}{|c||c|c|c||c|c|c|}
		...
		\hline
\end{tabular}
\captionof{table}{Comparaison de la précision des 3 méthodes sur une grille de référence de 6000 points pour le type MOX}
...
\begin{figure}[!h]\ContinuedFloat
		...
		\end{subfigure}
		\captionof{figure}{Comparaison des erreurs relatives (pcm) pour la section efficace $\Sigma_{s0}^{2\rightarrow1}$ de type UOX}
\end{figure}
...
\captionof{figure}{Courbes de convergence pour chaque section efficace de type MOX sans adaptivité}
...
D'un autre coté, nous avons vu que la méthode AI converge toujours pour tous les types de sections efficaces au bout d'un nombre d'itérations intèressant (500 dans la plupart des cas). On a vu aussi que cette méthode utilise dans la plupart des cas moins de points de calcul que la méthode de Tucker.
...
\begin{tabular}{|c||c|c|c||c|c|c|}
		...
		\hline
\end{tabular}
\captionof{table}{Comparaison de la précision des 3 méthodes sur une grille de référence de 6000 points pour le type UOX}
\end{table}
...
\begin{tabular}{|c||c|c|c||c|c|c|}
		...
		\hline
\end{tabular}
\captionof{table}{Comparaison de la précision des 3 méthodes sur une grille de référence de 6000 points pour le type UOX-Gd}
...
\begin{figure}[!h]\ContinuedFloat
		...
		\end{subfigure}
		\captionof{figure}{Comparaison des erreurs relatives (pcm) pour la section efficace $\Sigma_f^1$ de type UOX-Gd}
\end{figure}
\begin{figure}[!h]\ContinuedFloat
		\centering
		\begin{subfigure}[b]{0.45\textwidth}
		...
		\end{subfigure}
		\captionof{figure}{Comparaison des erreurs relatives (pcm) pour la section efficace $\Sigma_{s0}^{1\rightarrow2}$ de type MOX}
\end{figure}
\begin{figure}[!h]\ContinuedFloat
		\centering
		\begin{subfigure}[b]{0.45\textwidth}
		...
		\end{subfigure}
		\captionof{figure}{Comparaison des erreurs relatives (pcm) pour la section efficace $\Sigma_t^1$ de type UOX}
\end{figure}
...
\begin{subfigure}[b]{0.45\textwidth}
		...
		\end{subfigure}
		\captionof{figure}{Comparaison des erreurs d'approximation (pcm) de la réactivité pour le type d'assemblage UOX}
\end{figure}
...
\begin{subfigure}[b]{0.45\textwidth}
		...
		\end{subfigure}
		\captionof{figure}{Comparaison des erreurs d'approximation (pcm) de la réactivité pour le type d'assemblage UOX-GD}
\end{figure}
...
\captionof{figure}{Courbes de convergence pour chaque section efficace de type UOX}
\end{center}

\begin{center}
\includegraphics[height= 9 cm,width = \linewidth]{images/UOX-Gd/Convergence_speed.png}
\captionof{figure}{Courbes de convergence pour chaque section efficace de type UOX-Gd}
