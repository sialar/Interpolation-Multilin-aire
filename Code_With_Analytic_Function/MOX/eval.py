...
if __name__ == "__main__":
    ...
    #/**************************************************************************/
    values = []
    listOfCrossSectionNames = []

    for i in range(1,len(sys.argv)-5):
        listOfCrossSectionNames.append(sys.argv[i])

    point = []
    for i in range(1+len(listOfCrossSectionNames),len(sys.argv)):
        point.append(float(sys.argv[i]))

    for csName in listOfCrossSectionNames:
